...
def add_GreeterServicer_to_server(servicer, server):
    ...
    generic_handler = grpc.method_handlers_generic_handler(
            'infos.Greeter', rpc_method_handlers)
...
class Greeter(object):
    ...
    def SayHello(request,
            ...
            timeout=None,
            metadata=None):
        return grpc.experimental.unary_unary(request, target, '/infos.Greeter/SayHello',
    ...
    def SayHelloAgain(request,
            ...
            timeout=None,
            metadata=None):
        return grpc.experimental.unary_unary(request, target, '/infos.Greeter/SayHelloAgain',
            test__pb2.HelloRequest.SerializeToString,
            test__pb2.HelloReply.FromString,
            options, channel_credentials,
            insecure, call_credentials, compression, wait_for_ready, timeout, metadata)
